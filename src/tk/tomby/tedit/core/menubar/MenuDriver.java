/*
 * $Id: MenuDriver.java,v 1.1.1.1 2004/09/18 17:16:20 amunoz Exp $
 *
 ...
 */
public class MenuDriver extends GenericDriver {
    //~ Static fields/initializers *****************************************************************

    /** DOCUMENT ME! */
    private static final String RULES_FILE = "tk/tomby/tedit/core/menubar/menu-rules.xml";
     ...
     */
    public MenuDriver(String categoryName,
                      String resourceRoot) {
        super(RULES_FILE);
     ...
     */
    public Menu create() {
        return (Menu) createObject(resourceRoot + "/menu.xml");
    }
}
